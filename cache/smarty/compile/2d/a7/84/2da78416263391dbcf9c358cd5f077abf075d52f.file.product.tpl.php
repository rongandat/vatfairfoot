<?php /* Smarty version Smarty-3.1.14, created on 2013-09-06 06:30:05
         compiled from "/home/precya/public_html/vatfairfoot/themes/01premium/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10024317095229aeadb7c312-68741809%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2da78416263391dbcf9c358cd5f077abf075d52f' => 
    array (
      0 => '/home/precya/public_html/vatfairfoot/themes/01premium/product.tpl',
      1 => 1377879144,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10024317095229aeadb7c312-68741809',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5229aeaf057242_19618014',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5229aeaf057242_19618014')) {function content_5229aeaf057242_19618014($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/precya/public_html/vatfairfoot/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/precya/public_html/vatfairfoot/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/precya/public_html/vatfairfoot/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/precya/public_html/vatfairfoot/tools/smarty/plugins/function.counter.php';
?>
	...
	<div id="pb-right-column">
		...
		<?php if ($_smarty_tpl->tpl_vars['have_image']->value){?>
			<span id="view_full_size">
				<img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large_01prem');?>
" <?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value){?>class="jqzoom" alt="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'thickbox_01prem');?>
...
" <?php }?> id="bigpic"/>
				<span class="span_link_container"><span class="span_link"><?php echo smartyTranslate(array('s'=>'View full size'),$_smarty_tpl);?>
</span></span>
			</span>
		<?php }else{ ?>
			<span id="view_full_size">
...
" />
		...
		<!-- thumbnails -->
		<div id="views_block" class="clearfix <?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)<2){?>hidden<?php }else{ ?>carousel<?php }?>">
		<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>2){?><a id="view_scroll_left" class="hidden" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
...
" href="javascript:{}"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
		...
		<?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>1){?><p id="wrapResetImages" class="resetimg clear" style="display: none;"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
...
<?php }?>
	...
	<div id="pb-left-column">
		<h1><?php if (isset($_smarty_tpl->tpl_vars['product']->value->manufacturer_name)&&$_smarty_tpl->tpl_vars['product']->value->manufacturer_name!=''){?><span><?php echo $_smarty_tpl->tpl_vars['product']->value->manufacturer_name;?>
</span> <?php }?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
</h1>
...
$_smarty_tpl->tpl_vars['group_attribute']->_loop = true;
 $_smarty_tpl->tpl_vars['id_attribute']->value = $_smarty_tpl->tpl_vars['group_attribute']->key;
?>
									<li<?php if ($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value){?> class="selected"<?php }?>><a id="color_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute']->value);?>
...
" onclick="colorPickerClick(this);getProductAttribute();<?php if (count($_smarty_tpl->tpl_vars['colors']->value)>0){?>$('#wrapResetImages').show('slow');<?php }?>"><?php if (file_exists((($_smarty_tpl->tpl_vars['col_img_dir']->value).($_smarty_tpl->tpl_vars['id_attribute']->value)).('.jpg'))){?><img src="<?php echo $_smarty_tpl->tpl_vars['img_col_dir']->value;?>
...
<?php }?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_OOS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_OOS']->value){?>
				<!-- Out of stock hook -->
...
<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage'){?>
					<span class="reduction" id="reduction_percent_display">-<?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']*100;?>
%</span>
				<?php }?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attachment']->value['name'], 'htmlall', 'UTF-8');?>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value){?>
				<!-- accessories -->
				<div id="idTab4" class="block products_block accessories_block clearfix">
...
" class="product_image"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'medium_01prem');?>
