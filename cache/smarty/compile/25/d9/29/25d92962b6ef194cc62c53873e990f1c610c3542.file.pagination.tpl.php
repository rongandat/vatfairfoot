<?php /* Smarty version Smarty-3.1.14, created on 2013-09-06 06:32:14
         compiled from "/home/precya/public_html/vatfairfoot/themes/01premium/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7032974595229af2ee688b7-46497015%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25d92962b6ef194cc62c53873e990f1c610c3542' => 
    array (
      0 => '/home/precya/public_html/vatfairfoot/themes/01premium/pagination.tpl',
      1 => 1377879144,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7032974595229af2ee688b7-46497015',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5229af2f552979_51079590',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5229af2f552979_51079590')) {function content_5229af2f552979_51079590($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/precya/public_html/vatfairfoot/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (isset($_smarty_tpl->tpl_vars['p']->value)&&$_smarty_tpl->tpl_vars['p']->value){?>
	...
	<div class="pagination_container">
		...
		<?php if ($_smarty_tpl->tpl_vars['p']->value!=1){?>
			...
			<li class="pagination_previous"><a <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
">&laquo;&nbsp;<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
			<li class="pagination_previous" class="disabled"><span>&laquo;&nbsp;<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span></li>
		<?php }?>
...
"><?php echo intval($_smarty_tpl->tpl_vars['pages_nb']->value);?>
		...
		<?php if ($_smarty_tpl->tpl_vars['pages_nb']->value>1&&$_smarty_tpl->tpl_vars['p']->value!=$_smarty_tpl->tpl_vars['pages_nb']->value){?>
			...
			<li class="pagination_next"><a <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
&nbsp;&raquo;</a></li>
		<?php }else{ ?>
			<li class="pagination_next" class="disabled"><span><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
&nbsp;&raquo;</span></li>
		<?php }?>
		</ul>
	</div>
