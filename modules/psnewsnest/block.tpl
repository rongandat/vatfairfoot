...
{if $last_post_list && $last_post_list|@count > 0}
	...
	<h4>
        ...
        &nbsp; <a href="{$linkPosts}" title="{l s='Recent posts' mod='psnewsnest'}">{l s='Recent posts' mod='psnewsnest'}</a></h4>
	...
	<div class="block_content">
            ...
            <br />
            <p><a href="{$linkPosts}" title="{l s='View all posts' mod='psnewsnest'}">{l s='View all posts' mod='psnewsnest'} &raquo;</a></p>
	</div>
</div>
{/if}
<!-- /Block psblog module -->