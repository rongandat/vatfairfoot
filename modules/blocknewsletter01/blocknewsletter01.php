...
class blocknewsletter01 extends Module
{
	...
	{
		$this->name = 'blocknewsletter01';
		$this->tab = 'front_office_features';
		$this->need_instance = 0;

		parent::__construct();

		$this->displayName = $this->l('Newsletter block 01');
	...
	{
		$verif_url = Context::getContext()->link->getModuleLink('blocknewsletter01', 'verification', array(
			'token' => $token,
		));
	...
	public function hookDisplayLeftColumn($params)
	{
		...
		return $this->display(__FILE__, 'blocknewsletter01.tpl');
	}
	...
	{
		$this->context->controller->addCSS($this->_path.'blocknewsletter01.css', 'all');
	}
}
