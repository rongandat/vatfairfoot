...
<div id="best-sellers_block_right" class="block products_block">
	<h4><a href="{$link->getPageLink('best-sales')}">{l s='Top sellers' mod='blockbestsellers2'}</a></h4>
	...
	{if $best_sellers|@count > 0}
		...
		<p class="lnk"><a href="{$link->getPageLink('best-sales')}" title="{l s='All best sellers' mod='blockbestsellers2'}" class="button_large">&raquo; {l s='All best sellers' mod='blockbestsellers2'}</a></p>
	{else}
