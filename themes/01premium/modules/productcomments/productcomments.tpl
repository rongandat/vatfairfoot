...
<div id="idTab5">
	...
	{else}
		...
		<p>
			<a id="new_comment_tab_btn" class="open-comment-form" href="#new_comment_form">&raquo; {l s='Be the first to write your review' mod='productcomments'} !</a>
		</p>
		{else}
	...
	<div id="new_comment_form">
		<form action="#">
			...
			<div class="product clearfix">
				<img src="{$link->getImageLink($product->link_rewrite, $productcomment_cover, 'home_01prem')}" alt="{$product->name|escape:html:'UTF-8'}" />
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fr">
						...
						<input class="exclusive" id="submitNewMessage" name="submitMessage" type="submit" value="{l s='Send' mod='productcomments'}" />						
					</p>
					<div class="clearfix"></div>
				</div>
			</div>
