...
{if $special}
		<ul class="products clearfix">
			<li class="clearfix last_item first_item item">
				<a class="content_img" href="{$special.link}"><img src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'medium_01prem')}" alt="{$special.legend|escape:html:'UTF-8'}" title="{$special.name|escape:html:'UTF-8'}" /></a>
				<div class="text_desc">
					{if !$PS_CATALOG_MODE}
